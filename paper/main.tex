...
orders of magnitude of input gain.} The ranking is dominated by a
state-independent component of $w$ whose margin over the runner-up exceeds
anything an $11.5^\circ$ rotation can overturn---the state does not merely have
little influence, it has influence in a direction that does not compete with
what decides the ranking. (Large $\lambda$ is far out of distribution; this
