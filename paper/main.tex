...
Two things follow. First, the reward change is \emph{significant} on this axis:
paired against the improvement reward, $-0.1911$ on $9/10$ seeds,
Wilcoxon $p = 0.0371$, where the same comparison on final regret gave
$p = 0.375$. Second, MF-DRO's advantage over MF-MI-Greedy is concentrated
...
We report this as \textbf{supplementary}. The pre-registered success test is
defined on final regret and is unaffected: it fails, and the paired comparison
against MF-MI-Greedy on this axis ($p = 0.0645$) is no more significant at
$n{=}10$ than on the frozen one. What the anytime view adds is that the gap the
