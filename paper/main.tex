...
converging to approximately
$1.08\,\mu_H + 0.83\,\mu_L - 0.55\,\sigma_H - 0.30\,d_{\mathrm{inc}}$: a purely
exploitative, actively uncertainty-avoiding acquisition.
...
pathology this investigation began from. MF-DRO does not merely fail to
condition: trained on rollouts from an information-seeking MF-MES teacher, it
converges to a fixed rule that inverts the sign of its teacher's defining term.
