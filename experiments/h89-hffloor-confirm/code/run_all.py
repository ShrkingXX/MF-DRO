...
# Controls FIRST (Lesson 21): each treatment is measured against them, and a
# comparator that lands last cannot be checked early.
JOBS =[("Hartmann_6D","CONTROL",s) for s in SEEDS]
JOBS+=[("Borehole_8D","CONTROL",s) for s in SEEDS]
JOBS+=[("Hartmann_6D","HF-FLOOR",s) for s in SEEDS]
JOBS+=[("Borehole_8D","REFINE-100",s) for s in SEEDS]
