"""H89 worker: fresh-seed confirmation of the HF floor and teacher refinement.
...
# FIXED IN ADVANCE. The protocol forbids running any other value of
# real_hf_every or teacher_refine_samples on seeds 52-56: doing so would
# recreate the selection problem these confirmations exist to remove.
ARMS={
 "CONTROL":    dict(use_roi=False),
