...
ARMS=sys.argv[1:] or ["NOLFINIT","REWARD","TEACHER"]
JOBS=[("Borehole_8D",a,s) for a in ARMS for s in (44,46,48)]
...
with ThreadPoolExecutor(max_workers=9) as ex: list(ex.map(run,JOBS))
