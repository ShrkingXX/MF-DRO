"""h200A -- window(K=8) with the fidelity mix HELD FIXED. usage: worker_A.py <bench> <seed>
...
if __name__ == "__main__":
    ...
    tag = f"{bench}__H200A-WIN-FIDMATCH__seed{seed}"
    r = h83.run(bench, "MF-DRO", seed, os.path.join(RES, "ckpt", tag + ".json"))
    r["_h200"] = dict(arm="A", inference_context_k=8, max_hf_fraction=0.739, roi="Q10")
