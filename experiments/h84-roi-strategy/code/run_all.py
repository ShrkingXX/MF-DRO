...
BENCH=("Borehole_8D","Hartmann_6D")
ARMS=("ROI-Q10","ROI-ANN","ROI-FIX2")
JOBS=[(b,a,s) for a in ARMS for b in BENCH for s in SEEDS]
# live reproduction control for the reused h83 arm A -- 2 seeds per benchmark
JOBS+=[(b,"ROI-OFF",s) for b in BENCH for s in (42,43)]
