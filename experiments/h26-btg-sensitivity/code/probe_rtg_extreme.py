...
IN_BAND = [0.5, 0.6, 0.7, 0.8, 0.9, 1.0]   # realised RTG support
OOD_BTG = [1e-3, 1e-2, 0.1, 5.0, 10.0, 1e2, 1e3, 1e4, 1e6]
...
def main():
    ...
    f_in, c_in = run(mf, batch, bounds, IN_BAND, "IN-BAND RTG [0.5,1.0]")
    f_ood, c_ood = run(mf, batch, bounds, OOD_BTG, "EXTREME RTG 1e-3..1e6 -- reported separately")
    print("=" * 68)
