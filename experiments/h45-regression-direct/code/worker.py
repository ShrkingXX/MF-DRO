...
def run(seed):
    ...
    cfg=_build_mf_dro_config("h45","Hartmann_6D","reg",seed,bo_iterations=2000,
    ...
    cfg.use_candidate_scoring=False          # <-- the ONE variable
    ...
    return dict(arm="regression_direct", seed=seed, final_regret=float(reg[-1]),
...
if __name__=="__main__":
    ...
    with open(os.path.join(d,f"reg__seed{s}.json"),"w") as f: json.dump(o,f)
