"""h205A -- prefix only (arange labelling). usage: worker_A.py <bench> <seed>
...
if __name__ == "__main__":
    ...
    tag = f"{bench}__H205A-PREFIX__seed{seed}"
    r = h83.run(bench, "MF-DRO", seed, os.path.join(RES, "ckpt", tag + ".json"))
    r["_h205"] = dict(arm="A", absolute_timesteps=False, real_prefix_training=True,
