"""h205B -- absolute labelling only. usage: worker_B.py <bench> <seed>
...
if __name__ == "__main__":
    ...
    tag = f"{bench}__H205B-ABS__seed{seed}"
    r = h83.run(bench, "MF-DRO", seed, os.path.join(RES, "ckpt", tag + ".json"))
    r["_h205"] = dict(arm="B", absolute_timesteps=True, real_prefix_training=False,
