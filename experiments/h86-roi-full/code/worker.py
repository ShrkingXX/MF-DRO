"""H86 worker. MF-DRO + ROI-Q10 on the two benchmarks the ROI has never seen.
...
SPEC={"Currin_2D":dict(n_hf=5,n_lf=15),"Ackley_10D":dict(n_hf=10,n_lf=30),
      "Hartmann_6D":dict(n_hf=6,n_lf=45),"Borehole_8D":dict(n_hf=10,n_lf=20)}
...
def run(bench, arm, seed, ckpt_path):
    ...
    try:
        ...
        cfg=_build_mf_dro_config("h86",bench,arm,seed,bo_iterations=4000,num_epochs=10,
