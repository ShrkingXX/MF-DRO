...
ARMS=sys.argv[1:] or ["SF-DRO"]           # arms ALWAYS from argv
SEEDS=[42,43,45,47,49,50,51]              # 44/46/48 reused from h59
JOBS=[(b,a,s) for b in ("Borehole_8D","Currin_2D") for a in ARMS for s in SEEDS]
