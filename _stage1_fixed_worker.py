...
STOP_SENTINEL = "/tmp/stage1_fixed_STOP"

benchmark = sys.argv[1]
seed = int(sys.argv[2])
EXP_NAME = "mfdro_stage1_fixed"

tag = f"[MF-DRO-fixed {benchmark} seed{seed}]"
...
print(f"{tag} DONE seed={seed} | benchmark={benchmark} | final_regret={final_regret:.4f} | "
      f"lf_fraction={lf_frac:.3f} | mean_fid_mean={mean_fid_mean:.4f} | fid_mean_std={fid_mean_std:.4f}",
      flush=True)
